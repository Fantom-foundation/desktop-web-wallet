...
import UnstakeClaimCard from 'src/view/components/stake/unstakeClaimCard';
...
const Stake = props => {
  ...
  useEffect(() => {
    ...
    return () => {
      console.log('cleartimeout kapil');
  ...
  return (
    <div className="dashboard-container">
      ...
      <Row
        className={
          (deactivatedEpoch > 0 && timeLeft < 0) ||
          (selectedAddress && timeLeft > 0)
            ? 'mt-6'
            : ''
        }
      >
